...
export type BorderRadiusAttr = Partial<Record<`round-${typeof SIZE_NUMBERS[number]}` | 'round-full', boolean>>;
...
export type PositionAttr = Partial<Record<'absolute' | 'relative' | 'fixed' | 'static' | 'sticky', boolean>>;
